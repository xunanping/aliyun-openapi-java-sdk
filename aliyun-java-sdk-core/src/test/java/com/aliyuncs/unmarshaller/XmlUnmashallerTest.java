...
public class XmlUnmashallerTest {
  ...
  public void unmarshalTest() throws ClientException {
    ...
    String xml
        ...
        "<Regions>" +
            "<Region>" +
                ...
                "<LocalName>cn-shanghai</LocalName>" +
            "</Region>" +
            "<Region>" +
    ...
    try {
      ...
      Assert.assertEquals("SDK.UnmarshalFailed : unmarshal response from xml content failed, clazz = DescribeRegionsResponse, origin response = invalid xml", ex.getMessage());
      return;
    }
    Assert.fail();
  }
